...
- **Format:** `.trc` (SQL Trace), trace'y łącznie 5-10 GB na analizę (pliki po ok. 500 MB, sekwencja z jednego dnia to jeden trace). Wspierany zakres instancji klientów: SQL Server 2008 i nowsze.
...
| `fn_trace_gettable` nie czyta trace'ów ze starszych wersji (2008-2017) | Research finding | L | H | Sprawdzone tylko dla 2019; w teście przejścia użyć trace'u ze starszej wersji |
